//
// Problema 1 x 1 bi-apoiado com força no meio
//
...
// Força concentrada no ponto 2
// direção Y 
Physical Point("Fc,2,100.0") = {2};

// Prende os gls x e y dos nós do ponto 1 e somente o y do 3
Physical Point("U,1,0.0") = {1};
Physical Point("U,2,0.0") = {1,3};
